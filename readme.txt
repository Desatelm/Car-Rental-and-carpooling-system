...
3) From the root package edu.mum.cs.projects.carpooling, run the main() in a class named carpooling.java
...
5) Run the reporting app from root package edu.mum.cs.projects.carpooling. Just run the main() in:
Carpooling.java
